...
<body>
    <div class="container no-header-container">
        ...
        <form action="/selfCook/RegisterUser?action=register" method="post">
            <ul>
                <li>メールアドレス（ユーザー名）</li>
                <li><input type="email" name="email" placeholder="半角英数字" required></li>
            </ul>
            <ul>
                <li>ニックネーム</li>
                <li><input type="text" name="name" placeholder="表示するニックネーム" required></li>
            </ul>
            <ul>
                <li>パスワード</li>
                <li><input type="password" name="pass" placeholder="半角英数字" required></li>
            </ul>
